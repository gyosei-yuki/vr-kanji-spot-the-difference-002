    ...
    init: function () {
      ...
      el.addEventListener('raycaster-intersection', (evt) => {
        ...
        if (this.target_el.classList.contains('first-end')) {
          ...
          quiz1.setAttribute('material', { src: '#q-hou1', normalMap: '#q-hou1-NRM' });
          ...
          quiz2.setAttribute('material', { src: '#q-hou2', normalMap: '#q-hou2-NRM' });
          ...
          quiz3.setAttribute('material', { src: '#q-hou3', normalMap: '#q-hou3-NRM' });
          ...
          quiz4.setAttribute('material', { src: '#q-jyo1', normalMap: '#q-jyo1-NRM' });
          ...
          quiz5.setAttribute('material', { src: '#q-jyo2', normalMap: '#q-jyo2-NRM' });
          ...
          quiz6.setAttribute('material', { src: '#q-jyo3', normalMap: '#q-jyo3-NRM' });
          ...
          quiz7.setAttribute('material', { src: '#q-chou1', normalMap: '#q-chou1-NRM' });
          ...
          quiz8.setAttribute('material', { src: '#q-chou2', normalMap: '#q-chou2-NRM' });
          ...
          quiz9.setAttribute('material', { src: '#q-chou3', normalMap: '#q-chou3-NRM' });
          ...
          quiz10.setAttribute('material', { src: '#q-kaku1', normalMap: '#q-kaku1-NRM' });
          ...
          quiz11.setAttribute('material', { src: '#q-kaku2', normalMap: '#q-kaku2-NRM' });
          ...
          quiz12.setAttribute('material', { src: '#q-kaku3', normalMap: '#q-kaku3-NRM' });
